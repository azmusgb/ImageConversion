function showTab(tabId) {
    ...
    document.querySelector(`.tab-button[onclick="showTab('${tabId}')"]`).classList.remove('bg-gray-300', 'text-gray-700');
    document.querySelector(`.tab-button[onclick="showTab('${tabId}')"]`).classList.add('bg-green-500', 'text-white');
}
